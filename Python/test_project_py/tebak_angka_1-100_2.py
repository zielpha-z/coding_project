#Date (24/1/26)
# Project: "Permainan tebak angka"
# Membuat permainan/game yang bisa menebak angka dari 1-100 
# yang ada di pikiran seseorang
...
kalimat("Kalau kamu sudah menentukan angkanya,")
...
# Pemilihan mode permainan, dengan kesempatan/tanpa kesempatan
kalimat("Sebelum masuk ke permainannya, aku mau kamu pilih mode")
while True:
    kalimat("Apakah kamu mau ada kesempatan untuk aku menebak dan bertanya?", 1)
    print("1). Ya\n2). Tidak")
    jawab2 = input("Jawab: ")
    loading()
    if jawab2.isalpha():
...
if jawab2 == "YA":
    ...
    while True:
        ...
        if kesempatan.isalpha():
            ...
            if 3 < kesempatan <= 10:
                ...
                print("Hanya 4-10 kesempatan aja woi!")
    ...
    # Mesin utama binnary search nya mode kesempatan
    while kesempatan >= 1:
        while jawabh == "SALAH":
            if kesempatan > 1:
                percobaan +=1 
                ...
                while True:
                    ...
                    if jawabh.isalpha():
                        jawabh = jawabh.upper()
                        if jawabh == "SALAH":
                            kalimat("HmmHhmM, Salah? Oke kalau begitu")
                            break
                        elif jawabh == "BENAR":
                            break
                        else:
                ...
                # Pertanyaan mode kesempatan
                print(f"Pertanyaan ke-{percobaan}")
                while True:
                    kalimat(f"Apakah angka kamu lebih besar atau lebih kecil dari {angka}?", 1)
                    print("1). Besar\n2). Kecil")
                    jawab = input("Jawab: ")
                    if jawab.isalpha():
                        jawab = jawab.upper()
            ...
            # Elif kesempatan tersisa 1 dan kesempatan yang dikasih diatas 7
            elif kesempatan == 1 and kesempatanabs >= 7:
                kalimat("Aduh, Kesempatan ku tinggal 1")
                kalimat("Kalau begitu aku akan menebak")
                angka = random.randint(angka, angka2 + 1)
...
# Elif untuk mode bebas / tanpa kesempatan  
elif jawab2 == "TIDAK":
    ...
    while kesempatan >= 1: 
        while jawabh == "SALAH":
            ...
            # Elif kalau kesempatan nya sudah 1 di mode bebas 
            elif kesempatan == 1 and kesempatanabs == 7:
                kalimat("Aduh, Kesempatan ku tinggal 1")
